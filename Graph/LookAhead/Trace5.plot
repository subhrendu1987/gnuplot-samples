...
plot "< cat ". file1  \
	   using ($1-imgSep):($4) with boxes notitle lc rgbcolor "red" lt 1 fs pattern 3 ;
########################################################################################
########################################################################################
########################################################################################
#########################################################################################
...
outFile='ULF_exetime_2.eps'
set output outFile
#set title ""
set xlabel "Experiments"
set ylabel "Parse To Json(ms)"
set xrange [.5 : 3.5]
set yrange [0:.5]
set xtics 1
set ytics .25
...
file1="Data/Execution_Time_ulf.tsv"
plot "< cat ". file1  \
	   using ($1-imgSep):($3) with boxes notitle lc rgbcolor "black" lt 1 fs pattern 3 ;
########################################################################################
